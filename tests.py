...
class FlaskrTestCase(unittest.TestCase):
    ...
    def test_getting_trip(self):
        ...
        response = self.app.post('/trip/',data=json.dumps(dict(name="Another object")),headers=create_auth_header(True, "NewUser"),content_type='application/json')
        postResponseJSON = json.loads(response.data.decode())
        postedObjectID = postResponseJSON["_id"]
...
# this code doesn't test anything and will never fail
    ...
    def test_getting_non_existent_trip(self):
        response = self.app.post('/user/',data=json.dumps(dict(name="NewUser",password="test",)),content_type='application/json')
    ...
    def test_getting_other_users_trip(self):
        ...
        # create user2
        response = self.app.post('/user/',data=json.dumps(dict(name="NewUser2",password="test",)),content_type='application/json')
    ...
    def test_get_many_trips(self):
        ...
        response = self.app.post('/trip/',data=json.dumps(dict(name="First Trip")),headers=create_auth_header(True, "NewUser"),content_type='application/json')
            
        response = self.app.post('/trip/',data=json.dumps(dict(name="Second Trip")),headers=create_auth_header(True, "NewUser"),content_type='application/json')
...
# should require an authorization header
    def test_posting_trip(self):
        ...
        response = self.app.post('/trip/',data=json.dumps(dict(name="A trip")),headers=create_auth_header(True, "NewUser"),content_type='application/json')
...
# test case from Benji's code:
    ...
    def test_modifying_trip(self):
        ...
        response = self.app.post('/trip/',headers=create_auth_header(True, "NewUser"),data=json.dumps(dict(name="A Trip")),content_type='application/json')
                                     
        postResponseJSON = json.loads(response.data.decode())
        postedObjectID = postResponseJSON["_id"]
                                             
        # code from Benji, for put call:
        response = self.app.put('/trip/' + postedObjectID, headers=create_auth_header(True, "NewUser"), data=json.dumps(dict(name="San Francisco Roadtrip",_id=postedObjectID)),content_type='application/json')
    ...
    # should require an authorization header
        ...
        response = self.app.post('/trip/',data=json.dumps(dict(name="ToBeDeletedTrip")),headers=create_auth_header(True, "NewUser"),content_type='application/json')
        postResponseJSON = json.loads(response.data.decode())
        postedObjectID = postResponseJSON["_id"]
...
# User tests
    ...
    def test_valid_credentials(self):
        ...
        response = self.app.get('/user/' + postedObjectID,headers=create_auth_header(True, "NewUser"))
        responseJSON = json.loads(response.data.decode())
        self.assertEqual(response.status_code, 200)
    ...
    def test_verify_credentials_wrong(self):
        ...
        postResponseJSON = json.loads(response.data.decode())
        postedObjectID = postResponseJSON["_id"]
        response = self.app.get('/user/' + postedObjectID,headers=create_auth_header(False, "NewUser"))
        self.assertEqual(response.status_code, 401)
